        ...
        <table id="datatable1" class="table-datatable table table-striped table-hover mv-lg">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ url('tab_member/welfare/destroy') }}" method="POST" style="display:inline" onsubmit="return confirm('คุณแน่ใจใช่ไหม ?')">
                            {{ csrf_field() }}
                            <input type="hidden" name="welfare_id" value="{{ $welfare->id }}">
...
<div class="card">
    <div class="card-body">
        <form action="{{ url('tab_member/welfare') }}" method="POST" role="form" class="form-horizontal">
