...
<div class="card">
    <div class="card-body">
    	<form action="{{ route('tab_member.update', $tab_member->id) }}" method="POST" role="form" class="form-horizontal">
    		...
    		<fieldset>
    			...
    			<div class="form-group">
	    			...
	    			<div class="col-md-3 {{ $errors->has('name_prefix_id') ? 'has-error' : '' }}">
	    				<select class="form-control" name="name_prefix_id">
	    					...
	    					<option @if($name_prefix->id == old('name_prefix_id', $tab_member->name_prefix_id)) selected @endif value="{{ $name_prefix->id }}">{{ $name_prefix->name }}</option>
	    					@endforeach
	    				</select>
	    			...
	    			<div class="col-md-3 {{ $errors->has('firstname') ? 'has-error' : '' }}">
	    				<input type="text" name="firstname" class="form-control" placeholder="ชื่อ" value="{{ old('firstname', $tab_member->firstname) }}">
	    				@if($errors->has('firstname'))
	    				<span class="help-block">{{ $errors->first('firstname') }}</span>
	    				@endif
	    			</div>
	    			<div class="col-md-3  {{ $errors->has('lastname') ? 'has-error' : '' }}">
	    				<input type="text" name="lastname" class="form-control" placeholder="นามสกุล"  value="{{ old('lastname', $tab_member->lastname) }}">
    			...
    			<div class="form-group {{ $errors->has('old_no') ? 'has-error' : '' }}">
    				...
    				<div class="col-md-9">
	    				<input type="text" name="old_no" class="form-control" value="{{ old('old_no', $tab_member->old_no) }}" placeholder="หมายเลขสมาชิกเก่า">
    			...
    			<div class="form-group {{ $errors->has('gender') ? 'has-error' : '' }}">
    				...
    				<div class="col-md-9">
	    				<select class="form-control" name="gender">
	    					...
	    					<option @if(old('gender', $tab_member->gender) == 'ชาย') selected @endif value="ชาย">ชาย</option>
	    					<option @if(old('gender', $tab_member->gender) == 'หญิง') selected @endif value="หญิง">หญิง</option>
	    				</select>
    			...
    			<div class="form-group">
	    			...
	    			<div class="col-md-4 {{ $errors->has('nationality') ? 'has-error' : '' }}">
	    				<input type="text" name="nationality" class="form-control" placeholder="สัญชาติ" value="{{ old('nationality', $tab_member->nationality) }}">
	    				@if($errors->has('nationality'))
	    				<span class="help-block">{{ $errors->first('nationality') }}</span>
	    				@endif
	    			</div>
	    			<div class="col-md-4  {{ $errors->has('race') ? 'has-error' : '' }}">
	    				<input type="text" name="race" class="form-control" placeholder="เชื้อชาติ"  value="{{ old('race', $tab_member->race) }}">
	    				@if($errors->has('race'))
    			...
    			<div class="form-group {{ $errors->has('religion') ? 'has-error' : '' }}">
    				...
    				<div class="col-md-8">
	    				<input type="text" name="religion" class="form-control" value="{{ old('religion', $tab_member->religion) }}" placeholder="ศาสนา">
    		...
    		<fieldset>
    			...
    			<div class="form-group">
	    			...
	    			<div class="col-md-2 {{ $errors->has('home_number') ? 'has-error' : '' }}">
	    				<input type="text" name="home_number" class="form-control" placeholder="บ้านเลขที่" value="{{ old('home_number', $tab_member->home_number) }}">
	    				@if($errors->has('home_number'))
	    				<span class="help-block">{{ $errors->first('home_number') }}</span>
	    				@endif
	    			</div>
	    			<div class="col-md-1  {{ $errors->has('moo') ? 'has-error' : '' }}">
	    				<input type="text" name="moo" class="form-control" placeholder="หมู่"  value="{{ old('moo', $tab_member->moo) }}">
	    				@if($errors->has('moo'))
	    				<span class="help-block">{{ $errors->first('moo') }}</span>
	    				@endif
	    			</div>
	    			<div class="col-md-2  {{ $errors->has('village') ? 'has-error' : '' }}">
	    				<input type="text" name="village" class="form-control" placeholder="หมู่บ้าน/อาคาร/ชั้น"  value="{{ old('village', $tab_member->village) }}">
	    				@if($errors->has('village'))
	    				<span class="help-block">{{ $errors->first('village') }}</span>
	    				@endif
	    			</div>
	    			<div class="col-md-2  {{ $errors->has('soi') ? 'has-error' : '' }}">
	    				<input type="text" name="soi" class="form-control" placeholder="ซอย/ตรอก"  value="{{ old('soi', $tab_member->soi) }}">
	    				@if($errors->has('soi'))
	    				<span class="help-block">{{ $errors->first('soi') }}</span>
	    				@endif
	    			</div>
	    			<div class="col-md-2  {{ $errors->has('road') ? 'has-error' : '' }}">
	    				<input type="text" name="road" class="form-control" placeholder="ถนน"  value="{{ old('road', $tab_member->road) }}">
	    				@if($errors->has('road'))
    		...
    		<fieldset>
    			...
    			<div class="form-group {{ $errors->has('period_type') ? 'has-error' : '' }}">
    				...
    				<div class="col-md-9">
	    				<select class="form-control" name="period_type">
	    					...
	    					<option @if(old('period_type', $tab_member->period_type) == 'รายปี') selected @endif value="รายปี">รายปี</option>
	    					<option @if(old('period_type', $tab_member->period_type) == 'รายงวด') selected @endif value="รายงวด">รายงวด</option>
	    				</select>
    			...
    			<div class="form-group {{ $errors->has('blind_level') ? 'has-error' : '' }}">
    				...
    				<div class="col-md-9">
	    				<select class="form-control" name="blind_level">
	    					...
	    					<option @if(old('blind_level', $tab_member->blind_level) == 'ตาบอดสนิท') selected @endif value="ตาบอดสนิท">ตาบอดสนิท</option>
                            <option @if(old('blind_level', $tab_member->blind_level) == 'มองเห็นเลือนลางแต่ไม่สามารถอ่านหนังสือตัวพิมพ์ปกติได้') selected @endif value="มองเห็นเลือนลางแต่ไม่สามารถอ่านหนังสือตัวพิมพ์ปกติได้">มองเห็นเลือนลางแต่ไม่สามารถอ่านหนังสือตัวพิมพ์ปกติได้</option>
                            <option @if(old('blind_level', $tab_member->blind_level) == 'มองเห็นเลือนลางแต่สามารถอ่านหนังสือตัวพิมพ์ปกติได้โดยใช้แว่นสายตาหรืออุปกรณ์ช่วย') selected @endif value="มองเห็นเลือนลางแต่สามารถอ่านหนังสือตัวพิมพ์ปกติได้โดยใช้แว่นสายตาหรืออุปกรณ์ช่วย">มองเห็นเลือนลางแต่สามารถอ่านหนังสือตัวพิมพ์ปกติได้โดยใช้แว่นสายตาหรืออุปกรณ์ช่วย</option>
    			...
    			<div class="form-group {{ $errors->has('blind_cause') ? 'has-error' : '' }}">
    				...
    				<div class="col-md-9">
    					<textarea class="form-control" name="blind_cause" placeholder="สาเหตุความพิการ">{{ old('blind_cause', $tab_member->blind_cause) }}</textarea>
    			...
    			<div class="form-group {{ $errors->has('education_level') ? 'has-error' : '' }}">
    				...
    				<div class="col-md-9">
	    				<select class="form-control" name="education_level">
	    					...
	    					<option @if(old('education_level', $tab_member->education_level) == 'ประถมศึกษา') selected @endif value="ประถมศึกษา">ประถมศึกษา</option>
                            <option @if(old('education_level', $tab_member->education_level) == 'มัธยมตอนต้น') selected @endif value="มัธยมตอนต้น">มัธยมตอนต้น</option>
                            <option @if(old('education_level', $tab_member->education_level) == 'มัธยมตอนปลาย') selected @endif value="มัธยมตอนปลาย">มัธยมตอนปลาย</option>
                            <option @if(old('education_level', $tab_member->education_level) == 'ปริญญาตรี') selected @endif value="ปริญญาตรี">ปริญญาตรี</option>
                            <option @if(old('education_level', $tab_member->education_level) == 'ปริญญาโท') selected @endif value="ปริญญาโท">ปริญญาโท</option>
                            <option @if(old('education_level', $tab_member->education_level) == 'ปริญญาเอก') selected @endif value="ปริญญาเอก">ปริญญาเอก</option>
                            <option @if(old('education_level', $tab_member->education_level) == 'ประกาศนียบัตรวิชาชีพ') selected @endif value="ประกาศนียบัตรวิชาชีพ">ประกาศนียบัตรวิชาชีพ</option>
                            <option @if(old('education_level', $tab_member->education_level) == 'ประกาศนียบัตรวิชาชีพชั้นสูง') selected @endif value="ประกาศนียบัตรวิชาชีพชั้นสูง">ประกาศนียบัตรวิชาชีพชั้นสูง</option>
                            <option @if(old('education_level', $tab_member->education_level) == 'อื่นๆ') selected @endif value="อื่นๆ">อื่นๆ</option>
	    				</select>
    			...
    			<div class="form-group {{ $errors->has('education_name') ? 'has-error' : '' }}">
    				...
    				<div class="col-md-9">
	    				<input type="text" name="education_name" class="form-control" placeholder="จบจากสถานศึกษา"  value="{{ old('education_name', $tab_member->education_name) }}">
    			...
    			<div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
    				...
    				<div class="col-md-9">
	    				<select class="form-control" name="status">
	    					...
	    					<option @if(old('status', $tab_member->status) == 'โสด') selected @endif  value="โสด">โสด</option>
                            <option @if(old('status', $tab_member->status) == 'สมรส') selected @endif  value="สมรส">สมรส</option>
                            <option @if(old('status', $tab_member->status) == 'อย่าร้าง') selected @endif  value="อย่าร้าง">อย่าร้าง</option>
                            <option @if(old('status', $tab_member->status) == 'คู่สมรสเสียชีวิตแล้ว') selected @endif  value="คู่สมรสเสียชีวิตแล้ว">คู่สมรสเสียชีวิตแล้ว</option>
	    				</select>
    			...
    			<div class="form-group {{ $errors->has('career') ? 'has-error' : '' }}">
    				...
    				<div class="col-md-9">
	    				<input type="text" name="career" class="form-control" placeholder="อาชีพ"  value="{{ old('career', $tab_member->career) }}">
    			...
    			<div class="form-group {{ $errors->has('training') ? 'has-error' : '' }}">
    				...
    				<div class="col-md-9">
    					<textarea class="form-control" name="training" placeholder="หลักสูตรอบรม">{{ old('training', $tab_member->training) }}</textarea>
    			...
    			<div class="form-group {{ $errors->has('salary') ? 'has-error' : '' }}">
    				...
    				<div class="col-md-9">
	    				<input type="text" name="salary" class="form-control" placeholder="รายได้เฉลี่ยต่อเดือน"  value="{{ old('salary', $tab_member->salary) }}">
    			...
    			<div class="form-group {{ $errors->has('guarantor_type') ? 'has-error' : '' }}">
    				...
    				<div class="col-md-9">
	    				<select class="form-control" name="guarantor_type">
	    					<option value="">เลือกประเภท</option>
	    					<option @if(old('guarantor_type', $tab_member->guarantor_type) == 'บุลคลสามัญ') selected @endif value="บุลคลสามัญ">บุลคลสามัญ</option>
                            <option @if(old('guarantor_type', $tab_member->guarantor_type) == 'บุลคลวิสามัญ') selected @endif value="บุลคลวิสามัญ">บุลคลวิสามัญ</option>
                            <option @if(old('guarantor_type', $tab_member->guarantor_type) == 'บุลคลกิติมศักดิ์') selected @endif value="บุลคลกิติมศักดิ์">บุลคลกิติมศักดิ์</option>
                            <option @if(old('guarantor_type', $tab_member->guarantor_type) == 'นิติบุลคลสามัญ') selected @endif value="นิติบุลคลสามัญ">นิติบุลคลสามัญ</option>
                            <option @if(old('guarantor_type', $tab_member->guarantor_type) == 'นิติบุลคลวิสามัญ') selected @endif value="นิติบุลคลวิสามัญ">นิติบุลคลวิสามัญ</option>
                            <option @if(old('guarantor_type', $tab_member->guarantor_type) == 'นิติบุลคลกิติมศักดิ์') selected @endif value="นิติบุลคลกิติมศักดิ์">นิติบุลคลกิติมศักดิ์</option>
                            <option @if(old('guarantor_type', $tab_member->guarantor_type) == 'คณะบุลคลสามัญ') selected @endif value="คณะบุลคลสามัญ">คณะบุลคลสามัญ</option>
                            <option @if(old('guarantor_type', $tab_member->guarantor_type) == 'คณะบุลคลวิสามัญ') selected @endif value="คณะบุลคลวิสามัญ">คณะบุลคลวิสามัญ</option>
                            <option @if(old('guarantor_type', $tab_member->guarantor_type) == 'คณะบุลคลกิติมศักดิ์') selected @endif value="คณะบุลคลกิติมศักดิ์">คณะบุลคลกิติมศักดิ์</option>
    			...
    			<div class="form-group {{ $errors->has('guarantor_name') ? 'has-error' : '' }}">
    				...
    				<div class="col-md-9">
	    				<input type="text" name="guarantor_name" class="form-control" placeholder="สมาชิกสามัญผู้รับรองคุณสมบัติ"  value="{{ old('guarantor_name', $tab_member->guarantor_name) }}">
...
<script type="text/javascript">
	var province_id = '{{ old('province_id', $tab_member->sub_district->district->province->id) }}';
	var district_id = '{{ old('district_id', $tab_member->sub_district->district->id) }}';
    var sub_district_id = '{{ old('sub_district_id', $tab_member->sub_district_id) }}';
    var zipcode_id = '{{ old('zipcode_id', $tab_member->sub_district->zipcode->id) }}';
